...
export function getCatalogByCapability(source_type, facet) {
    return CATALOG.filter((e) => e.source_types.includes(source_type) && (e.facet === facet || e.facet === 'transcription_diarization_bundled' && (facet === 'transcription' || facet === 'diarization')));
}
