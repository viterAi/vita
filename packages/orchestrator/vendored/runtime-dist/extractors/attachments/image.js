...
const PROMPT = 'Examine this image. Output JSON with exactly these fields:\n' +
...
function inferImageMime(filename, declaredMime) {
...
export async function extractImage(input, ctx) {
    if (!ctx.openrouterApiKey)
        throw new Error('OPENROUTER_API_KEY required for image extractor');
